# Echelette perfectly conducting grating
# 
# - A echelette perfectly conducting grating of period 600nm 
# - blaze angle b = 30, apex angle A = 90
...
function pec_grid(;lc = 0.1)
    ...
    p2 = gmsh.model.geo.addPoint(0.75, sqrt(3) / 4, 0.0, lc)
    p3 = gmsh.model.geo.addPoint(1.0, 0.0, 0.0, lc)
    p4 = gmsh.model.geo.addPoint(1.0, 1.0, 0.0, lc)
    p5 = gmsh.model.geo.addPoint(0.0, 1.0, 0.0, lc)
